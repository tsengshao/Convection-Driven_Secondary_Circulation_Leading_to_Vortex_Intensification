...
def main(
    ...
    if iswhite:
        figdir = f"./fig10_{center_flag}_sap_white/{tag}/"
    else:
        figdir = f"./fig10_{center_flag}_sap/{tag}/"
    ...
    for exp in ['RRCE_3km_f00_10', 'RRCE_3km_f00_20', 
                'RRCE_3km_f00_25', 'RRCE_3km_f00_30']:
